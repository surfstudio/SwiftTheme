...
class ChangeThemeCell: BaseCell {
    ...
    override func awakeFromNib() {
        ...
        changeTheme.themeSetTitleColor(["#FFF", "#000", "#FFF", "#000"], forState: .normal)
        changeTheme.themeSetTitleColor(["#555", "#AAA", "#555", "#AAA"], forState: .highlighted)
        changeTheme.themeBackgroundColor = ["#EB4F38", "#F4C600", "#56ABE4", "#ECF0F1"]
